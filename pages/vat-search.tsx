...
export default function VatSearch() {
            ...
            <div className="bg-vat-secondary relative isolate px-6 pt-14 pb-14 lg:px-8  flex flex-col justify-around">
              <div className="mx-auto max-w-2xl">
                <div className="text-center">
                  ...
                  <form className="mt-4" method="GET" action="/vat-search">
                    {" "}
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        type="search"
                        id="default-search"
                        className="block w-full p-4 pl-10 text-sm text-gray-900 border  rounded-lg bg-gray-50 focus:ring-vat-primary border-vat-primary focus:outline"
                      ...
                      <button
                        type="submit"
                        className="text-white absolute right-2.5 bottom-2.5 bg-vat-primary hover:bg-vat-primary-800 focus:ring-4 focus:outline-none focus:ring-vat-primary-300 font-medium rounded-lg text-sm px-4 py-2 "
                      >
                        To search
                      </button>
                    </div>
              ...
              <section className="mx-auto flex max-w-3xl items-center justify-between p-6 lg:px-8">
                <div className="flex flex-col gap-3 w-full">
                  ...
                  {searchResultData.map((chamber) => (
                    <>
                      <Link
                        href={`/vat/order/${chamber.kvkNummer}/product-select`}
