              ...
              <div className="text-center">
                <p className="text-lg leading-8 text-gray-900 flex flex-col gap-6 justify-between">
                  ...
                  <span>
                    ...
                    <Link
                      href="/vat-search"
                      className="inline-flex gap-2 items-center rounded-md bg-vat-primary px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:opacity-80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
